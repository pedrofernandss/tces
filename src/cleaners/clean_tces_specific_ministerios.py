...
def remover_ministerios(database: pd.DataFrame) -> pd.DataFrame:
    ministerios_a_manter = ["Ministério Do Desenvolvimento Agrário", "Ministério Do Desenvolvimento Social E Combate A Fome",
...
def limpar_database_convenios(url) -> pd.DataFrame:
    ...
    df_tces = remover_ministerios(df_tces)
